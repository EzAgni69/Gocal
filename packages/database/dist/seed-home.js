...
function seed() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!user) {
            ...
            const [newUser] = yield db_1.db.insert(require('./schema').users).values({
        ...
        yield db_1.db.delete(schema_1.homeCards);
        ...
        yield db_1.db.delete(schema_1.vendors).where(inArray(schema_1.vendors.slug, slugs));
        console.log("Inserting vendors...");
        try {
            const [v1] = yield db_1.db.insert(schema_1.vendors).values({
                ownerId: user.id,
            ...
            const [v2] = yield db_1.db.insert(schema_1.vendors).values({
                ownerId: user.id,
            ...
            yield db_1.db.insert(require('./schema/products').products).values([
                {
                    vendorId: v1.id,
            ...
            yield db_1.db.insert(schema_1.homeCards).values([
